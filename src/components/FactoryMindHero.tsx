...
.fmx-reference-hero picture,.fmx-reference-hero picture img{display:block;width:100%;height:auto}
.fmx-reference-hero picture img{object-fit:contain}
...
/* Desktop reference crop: 970 x 438 */
...
/* Tablet reference crop: 499 x 460 */
...
/* Mobile reference crop: 220 x 463 */
...
export default function FactoryMindHero({ menuOpen, onToggleMenu }: Props) {
  return (
    <section className="fmx-reference-hero" aria-label="FactoryMind home hero">
      <style>{styles}</style>
      <picture>
        <source media="(max-width:650px)" srcSet="/reference/mobile-site.avif" />
        <source media="(max-width:1000px)" srcSet="/reference/tablet-site.avif" />
        <img src="/reference/desktop-site.avif" alt="FactoryMind industrial AI platform" />
      </picture>
